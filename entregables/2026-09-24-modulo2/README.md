...
| `modulo2-PF1821-PF1822-completo.pdf` | **Todo en un solo documento** (75 págs.): por cada curso, ficha SIPFOR textual, entregables con cantidades para el 7,0 y el kit de recursos completo. Se regenera con `npm run kit -- PF1821 PF1822 --salida entregables/2026-09-24-modulo2 --pdf --unico`. | — (nuevo) |
| `kit-recursos-modulo2-PF1821.pdf` | **Kit de recursos educativos del módulo 2 de PF1821**, desarrollado: bienvenida, infografía, 4 cápsulas, cuadro comparativo, tutorial, video interactivo, 2 actividades con respuesta modelada, 13 indicadores, 3 instrumentos, portafolio, retroalimentación y metodología. 29 págs. Fuente: `contenidos/PF1821/modulo-2/`. | — (nuevo) |
| `kit-recursos-modulo2-PF1822.pdf` | **Kit de recursos educativos del módulo 2 de PF1822**, con la misma estructura, código Python incluido. 32 págs. Fuente: `contenidos/PF1822/modulo-2/`. | — (nuevo) |
