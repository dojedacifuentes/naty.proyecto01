...
| P11 | Cuadro comparativo n8n · Make · Zapier | AE1 | C4 d) | `contenidos/PF1821/modulo-2/R-capsulas.md` (R04) | PDF o tabla en el LMS | pendiente | | |
| P12 ★ | Herramienta didáctica 1: tutorial "Tu primer workflow" | AE2, AE3 | C4 | `C4-herramientas-didacticas.md` | n8n (capturas) + página del LMS | pendiente | | |
| P13 ★ | Herramienta didáctica 2: video interactivo "Expresiones y depuración" | AE3, AE4 | C4 | `C4-herramientas-didacticas.md` | HeyGen + H5P Interactive Video | pendiente | | |
| P14 ★ | Actividad 1 (ABP): "Del formulario a la base de datos" | AE1–AE3 | C2 | `C2-actividades.md` | Página del LMS + insumos | pendiente | | |
| P15 ★ | Actividad 2 (ABPRO, gamificada): "Rescate del workflow roto" + workflow roto en JSON | AE1, AE3, AE4 | C2 | `C2-actividades.md` | n8n (exportar JSON) + página del LMS | pendiente | | |
| P16 | Documentos evaluativos (9 PDF sin logo para el curso base) | todos | B2 a B4 | `B2`, `B3` y `B4` | IA de texto o procesador de texto | pendiente | | |
| P17 | Curso base del módulo 2 en Moodle | todos | C (todo el ítem) | Etapa 2 del flujo | Moodle | pendiente | | |
| P18 | Anexo 2: secciones IV (módulo 2), V y VI | todos | B y C | Etapa 3 del flujo | Formato oficial + molde V0 | pendiente | | |
| P19 | Revisión de Natalia contra el checklist | todos | — | `../README.md` | — | pendiente | | |

Pendientes que no son piezas: quién paga las cuentas de n8n y Supabase en cada institución, y
el LMS de cada una (`state/OPEN-QUESTIONS.md` #5 y #6).
