...
| D3 ★ | A | Herramienta 1 (AE3): notebook "Laboratorio de prompts" | `entrega/herramientas/M2-Herramienta-1-Notebook.ipynb` | `contenidos/PF1822/modulo-2/notebook/` | listo para revisión, **sin ejecutar** (ver E1) | `entrega/herramientas/` | claude-code |
